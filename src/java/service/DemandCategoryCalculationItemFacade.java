...
public class DemandCategoryCalculationItemFacade extends AbstractFacade<DemandCategoryCalculationItem> {
    ...
    public List<DemandCategoryCalculationItem> save(DemandCategoryCalculation demandCategoryCalculation, DemandCategory demandCategory, boolean simuler, boolean isSave) throws ScriptException {
        ...
        for (DepartementCriteriaItem departementCriteriaItem : departementCriteriaItems) {
            ...
            demandCategoryCalculationItem.setPrice((BigDecimal) calculationExpressionFacade.evalFunction(departementCriteriaItem.getArithmitiqueExpresionForUnitePrice(), demandCategory));
            demandCategoryCalculationItem.setPriceGlobal((BigDecimal) calculationExpressionFacade.evalFunction(departementCriteriaItem.getArithmitiqueExpresionForGlobalPrice(), demandCategory));
            if (!simuler) {
                if (isSave) {
