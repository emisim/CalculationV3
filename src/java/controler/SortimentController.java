...
public class SortimentController implements Serializable {
    ...
    public Sortiment getSelected() {
        return selected;
    }

    public void setSelected(Sortiment selected) {
    ...
    private SortimentFacade getFacade() {
        return ejbFacade;
    }

    public Sortiment prepareCreate() {
        selected = new Sortiment();
        initializeEmbeddableKey();
        return selected;
    }

    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("SortimentCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("SortimentUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("SortimentDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public List<Sortiment> getItems() {
        if (items == null) {
    ...
    public static class SortimentControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Sortiment) {
                Sortiment o = (Sortiment) object;
                return getStringKey(o.getId());
            } else {
                Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Sortiment.class.getName()});
                return null;
            }
        }
