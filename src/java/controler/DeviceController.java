...
public class DeviceController implements Serializable {
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("bundles/Bundle").getString("DeviceUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("bundles/Bundle").getString("DeviceDeleted"));
        if (!JsfUtil.isValidationFailed()) {
        ...
        if (selected != null) {
            ...
            try {
                ...
                if (msg.length() > 0) {
                    ...
                    JsfUtil.addErrorMessage(ex, ResourceBundle.getBundle("bundles/Bundle").getString("PersistenceErrorOccured"));
                }
            } catch (Exception ex) {
